...
export class CamelotV2Pool extends Pool {
...
function calculateStableSwap(pool: CamelotV2Pool, tokenIn: string, tokenOut: string, amountIn: BigNumber): bigint {
...
function _k(pool: CamelotV2Pool): BigNumber {
...
function calculateRegularSwap(pool: CamelotV2Pool, tokenIn: string, tokenOut: string, amountIn: BigNumber): bigint {
